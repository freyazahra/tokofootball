...
from main.views import home, show_xml, show_json, show_xml_by_id, show_json_by_id,  create_product, product_detail, register, login_user, logout_user, edit_product, delete_product, search_product
